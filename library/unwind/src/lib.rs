...
// For pauthtest explicitly reject static CRT, as it requires dynamic linking. Pauthtest is based on
// musl, the only supported unwinding mechanism is provided by libunwind.
