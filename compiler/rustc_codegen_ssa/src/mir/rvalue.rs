                    ...
                    mir::CastKind::PointerCoercion(PointerCoercion::ReifyFnPointer(_), _) => {
                        match *operand.layout.ty.kind() {
                            ty::FnDef(def_id, args) => {
                                ...
                                .unwrap();
                                OperandValue::Immediate(bx.get_fn_addr(instance, Some(PacMetadata { key: 0, disc: 0, addr_diversity: AddressDiversity::None }),))
                            }
                    ...
                    mir::CastKind::PointerCoercion(PointerCoercion::ClosureFnPointer(_), _) => {
                        match *operand.layout.ty.kind() {
                            ty::Closure(def_id, args) => {
                                ...
                                OperandValue::Immediate(bx.cx().get_fn_addr(instance, Some(PacMetadata { key: 0, disc: 0, addr_diversity: AddressDiversity::None }),))
                            }
