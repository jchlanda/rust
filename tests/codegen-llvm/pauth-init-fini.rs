...
//@ revisions: O0_PAUTH O3_PAUTH O0_PAUTH_DISABLE_INIT_FINI_ADDR_DISC O3_PAUTH_DISABLE_INIT_FINI_ADDR_DISC
...
//@ [O0_PAUTH_DISABLE_INIT_FINI_ADDR_DISC] needs-llvm-components: aarch64
//@ [O0_PAUTH_DISABLE_INIT_FINI_ADDR_DISC] compile-flags: --target=aarch64-unknown-linux-pauthtest -Z pauth_disable_init_fini_addr_discriminator -C opt-level=0
//@ [O3_PAUTH_DISABLE_INIT_FINI_ADDR_DISC] needs-llvm-components: aarch64
//@ [O3_PAUTH_DISABLE_INIT_FINI_ADDR_DISC] compile-flags: --target=aarch64-unknown-linux-pauthtest -Z pauth_disable_init_fini_addr_discriminator -C opt-level=3
